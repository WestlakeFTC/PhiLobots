...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// gyro_enocoder_fused is the file where we keep all miscellaneous methods() we need for our main programs(library)  //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
const int TURN_POWER=100; // motor power for turning
const int easing_zone =20; //to be tuned
const int TOLERANCE=1; //
const int robotHalfWidth = 8.25; // half the width of the robot(for the turning calculations)
const int wheelRad = 2; // rad of the wheel(for turning calcs)
const float kp = 1.0/easing_zone; // PID control
...
void controlledStraightMove(int inches, int power){ //move straight with set power
if(inches == 0){return;}
...
void encoderTurn(int degrees){ //turn using the encoders
	nMotorEncoder[FrontL] = 0;
	nMotorEncoder[FrontR] = 0;
int full_power =degrees>0? -TURN_POWER:TURN_POWER;
	int power=full_power;
