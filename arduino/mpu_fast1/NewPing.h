...
#ifndef NewPing_h
#define NewPing_h
#include "PinChangeInt.h"//for pin change interrupts
...
#define ECHO_TIMER_FREQ 240      // Frequency to check for a ping echo (every 24uS is about 0.4cm accuracy). Default=24
...
class NewPing {
	public:
		...
		void ping_interrupt(PCIntvoidFuncPtr userFunc);
		void ping_interrupt2( PCIntvoidFuncPtr userFunc);
